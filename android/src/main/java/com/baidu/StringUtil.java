...
//	}
    ...
    public static boolean isEmpty(String value) {
        if (null != value && !"".equalsIgnoreCase(value.trim())
                && !"null".equalsIgnoreCase(value.trim()) && !"default".equalsIgnoreCase(value.trim())) {
            return false;
        } else {
            return true;
        }
...
//			}
    ...
    /**
     * 设置同一个text view中某个字符颜色为橘黄色
     *
     * @param str 不一致的字符
     * @return 字符
     */
    public static String getDiffColorText(String str) {
        if (!StringUtil.isEmpty(str)) {
            str = "<font color=\"#e68e29\">" + str + "</font>";
            return str;
        }
        return "";
    }
...
//	 * @param state 状态
//	 */
//	public static String errMsg(int state){
//		LogUtil.showLog("state="+state);
//		String text;
//		switch (state){
//			case -1://服务器错误
//				text = App.getContext().getString(R.string.service_error);
//				break;
//			case 1002://没有数据
//				text = App.getContext().getString(R.string.no_data);
//				break;
//			default://其他错误
//				text = App.getContext().getString(R.string.net_error);
//				break;
//		}
//		return text;
//	}
