package com.flutter_bdface.bdface.widget;
/*
...
public class FaceRoundView extends View {
    ...
    public static final int COLOR_BG = Color.parseColor("#626262");
    public static final int COLOR_RECT = Color.parseColor("#626262");
    public static final int COLOR_ROUND = Color.parseColor("#409EFF");
